Refinery::Resources.configure do |config|
  ...
  # config.dragonfly_secret = "38030833480c8fc882345ab285b92f2cc047e4c14d0d5051"
  # config.dragonfly_url_format = "/system/resources/:job/:basename.:format"
  # config.datastore_root_path = "/Users/alistair/Dev/Rails/ali_cms/public/system/refinery/resources"
